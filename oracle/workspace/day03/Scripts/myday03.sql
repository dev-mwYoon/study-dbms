...
SELECT S.GRADE 
FROM SALGRADE s JOIN EMP e 
ON BETWEEN S.LOSAL AND B = E.SAL ; 
...
FROM TEAM t JOIN PLAYER p
ON T.TEAM_ID = P.TEAM_ID
GROUP BY MAX(P.HEIGHT) HAVING TEAM_ID;

SELECT P.*
FROM TEAM t JOIN PLAYER p
ON T.TEAM_ID = P.TEAM_ID AND P.HEIGHT = MAX(P.HEIGHT)
GROUP BY TEAM_ID;

SELECT P.*
FROM TEAM t JOIN PLAYER p
ON T.TEAM_ID = P.TEAM_ID 
GROUP BY T.TEAM_ID HAVING 
(
...
SELECT *
FROM PLAYER p 
GROUP BY TEAM_ID HAVING MAX(HEIGHT) != P.HEIGHT ; 

SELECT P.TEAM_ID, MAX(HEIGHT) "팀 내 최장키"
FROM TEAM T JOIN PLAYER P 
ON T.TEAM_ID = P.TEAM_ID
GROUP BY P.TEAM_ID 
ORDER BY T.TEAM_ID;
...
/*팀별 최장 키*/
/*이것의 값과 PLAYER HEIGHT값이 같을 때 정보 출력*/

SELECT DISTINCT MAX(HEIGHT) 
FROM PLAYER p 
GROUP BY TEAM_ID 
ORDER BY MAX(HEIGHT)  ;
